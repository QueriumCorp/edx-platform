    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('eop_student', 'EOP Student'), ('tester', 'Rover Tester'), ('free_retake', 'Free Retake')], default='eop_student', help_text='Type of E-Commerce whitelist user.', max_length=24)),
            ],
            options={
