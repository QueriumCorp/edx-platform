...
class InheritanceMixin(XBlockMixin):
    ...
    stepwise_weight = Float(
        ...
        help=_(
            ...
            'For example, a Stepwise problem is worth a possible 3.0 raw points, less deductions.  The net raw score is then',
            'scaled to 1.0 points, and multiplied by this weight.',
            'Setting this weight to 5.0 makes each StepWise question worth 5.0 points in the gradebook.',
    ...
    stepwise_max_attempts = Integer(
        display_name="StepWise Maximum Attempts",
        help=_(
            'Enter the maximum number of times a student can try to answer problems. By default, StepWise Maximum Attempts is set to "null",',
            'meaning that students have an unlimited number of attempts for StepWise problems. You can override this course-wide setting for',
            'individual problems. However, if the course-wide setting is a specific number, you cannot set the Maximum Attempts for individual',
    ...
    stepwise_grade_errors_ded = Float(
        ...
        help=_(
            ...
            'Points are deducted from 3.0 points and then scaled to a score of 1.0 based on the defined weight for the question.',
            'Individual StepWise questions can override this setting.'
        ),
        default=1.0,
        scope=Scope.settings
    ...
    stepwise_grade_showme_ded = Float(
        display_name=_('StepWise Show Solution Deduction'),
        help=_(
            'Point deduction out of 3.0 points for using the "Show Solution" button in a question (Default: 3.0).',
            'Points are deducted from 3.0 points, then the resulting points are scaled to a score of 1.0, then the score is multiplied by the defined weight for the question.',
            'Individual StepWise questions can override this setting.'
        ),
        default=3.0,
        scope=Scope.settings
    ...
    stepwise_grade_hints_ded = Float(
        display_name=_('StepWise Hints Deduction'),
        help=_(
            'Point deduction out of 3.0 points for using more hints than allowed (Default: 1.0).',
            'Advisory hints generated by StepWise do not count against this number.',
            'Points are deducted from 3.0 points, then the resulting points are scaled to a score of 1.0, then the score is multiplied by the defined weight for the question.'
            'Individual StepWise questions can override this setting.'
        ),
        default=3.0,
    ...
    stepwise_grade_min_steps_count = Integer(
        ...
        help=_(
            'Number of valid steps must enter to get full credit if they would otherwise get full credit for a question (Default: 3).',
            'Points are deducted from 3.0 points, then the resulting points are scaled to a score of 1.0, then the score is multiplied by the defined weight for the question.'
            'Individual StepWise questions can override this setting.'
        ),
        default=2,
