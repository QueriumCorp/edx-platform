...
class InheritanceMixin(XBlockMixin):
    ...
    stepwise_weight = Float(
        ...
        help=_(
            ...
            'The net raw score is then scaled to 1.0 points, and multiplied by this weight. '
    ...
    stepwise_max_attempts = Integer(
        ...
        help=_(
            'Enter the maximum number of times a student can try to answer problems. '
            'By default, StepWise Maximum Attempts is set to "null", '
            'meaning that students have an unlimited number of attempts for StepWise problems. '
